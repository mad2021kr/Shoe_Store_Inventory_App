    ...
    override fun onCreateView(
        ...
        binding.saveBtn.setOnClickListener {
            if (binding.nameEditText.text.isEmpty() || binding.companyEditText.text.isEmpty()
                ...
                ShoeViewModel().addShoeData(ShoeDetail(binding.nameEditText.text.toString(), binding.companyEditText.text.toString(), binding.sizeEditText.text.toString().toInt(), binding.descriptionEditText.text.toString()))
